...
--   * exactly 20 of the 26 core entries are gated (pinned count guards
...
describe("plugin_spec", function()
  ...
  it("each gated entry's enabled() reflects lvim.builtin.<name>.active", function()
    ...
    -- Exact count: 20 gated entries out of 26 total, so 26 = 20 gated + 6
